...
interface IdentitySectionProps {
  ...
  onRegistrationOpen: (isOpen: boolean) => void
}
...
export function IdentitySection({ isActive, onIdentitySelected, onAnimationComplete, identityComplete, onRegistrationOpen }: IdentitySectionProps) {
